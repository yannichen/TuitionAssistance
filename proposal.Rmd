...
So, the question was proposed - `How does the Tuition Assistance Program (TAP) distribute its financial aid?` In other words, we want to investigate the decision making process of the TAP program to see the important features that may affect the disposal of the financial aid and dollar amounts being provided. Speficially, We would like to investigate  `which feature group, based on both academic and non academic backgrounds, has more recipient` and `does being in a specific feature group results in receiving more financial aid`. 
